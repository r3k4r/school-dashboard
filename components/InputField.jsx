...
const InputField = ({label, type, register, name, defaultValue, error}) => {
  return (
    <div className='flex flex-col items-start justify-start relative'>
        ...
        <input defaultValue={defaultValue}  id="username" type={type} className={` w-[230px] bg-white border-2 border-gray-300 p-2 rounded-lg  ${error?.message && 'border-red-600'} `} {...register(name)} />
